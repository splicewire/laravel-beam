 ...
 *
 * The properties are house-style camelCase; the retained `#[MapInputName]` is what fixes the wire keys
 * as `query_parameters` / `is_default` under a host's global CamelCaseMapper. Note the asymmetry this
 * preserves and does not invent: the ENVELOPE keys are snake, while the facet names INSIDE
 * `query_parameters` are camelCase (ticket 22 / `FacetName::for()`).
 *
