...
use Splicewire\Beam\Schema\JsonDocumentShape;
...
class SchemaIntakeValidator
{
    ...
    /**
     * The submitted payload as the JSON DOCUMENT it was, with every empty object restored. The walk
     * lives in {@see JsonDocumentShape} so the migrate-on-read gate spells an empty value the same way
     * this door does.
     *
    ...
    {
        return (new JsonDocumentShape)->restore($value, $schema, $root);
    }
