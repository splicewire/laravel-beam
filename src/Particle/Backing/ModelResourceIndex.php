 ...
 * sibling `SchemaBindingIndex`, which rejects duplicate explicit schema claims. A schema `$id` names
 * one Data projection, while a model may participate in many resources.
 *
