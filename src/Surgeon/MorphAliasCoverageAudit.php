...
class MorphAliasCoverageAudit implements DoctorAudit
{
     ...
     *
     * Delegates to {@see FamilyPackageSource}, which this method WAS until MorphTokenBypassAudit needed
     * the identical reach. Two copies of "what counts as family source" is the fork shape this estate
     * keeps paying for, so it moved and both audits read one answer.
     *
     * @return array<string, list<string>>
     */
    protected function familyPackageSourceDirs(): array
    {
        return (new FamilyPackageSource)->dirs();
    }

    protected function isFamily(string $package): bool
    {
        return (new FamilyPackageSource)->isFamily($package);
    }
