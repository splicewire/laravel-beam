 ...
 * leaves alone.
 */
class DocblockTierAudit implements DoctorAudit, SuggestsOperations
{
    /**
     ...
     * diagnosis as {@see suggestOperations()} with the fix-suggestion dropped, so one registration in
     * {@see BeamDoctorManifest} serves both `splicewire:beam:doctor` and
     * surgeon's `surgeon:audit` sweep.
     *
     * @return list<Finding>
     */
