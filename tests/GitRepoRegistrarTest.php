...
/**
 * The actual point of mirror-status-ui ticket 02 (promoted here from laravel-beam-ux via
 * surgeon:move — a repo-status cache is generic infra, not a beam-ux-specific concept): N files
 * under the SAME repo cost ~1 `git` process spawn, not N. Real `git` (isolated temp trees), never a
