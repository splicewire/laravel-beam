...
/**
 * A Read with no ability: legitimate, because a Read's gate is its query scope. Out of scope by design.
 *
 ...
 */
#[ParticleOp(resource: 'op-gate-fixtures', name: 'ungated-read', kind: OperationKind::Read)]
class UngatedReadOpFixture
{
