 ...
 * projection seam: `ReadContext::includes` controls the spatie serialization partial, so a Lazy
 * property appears only when included. Query composition is tested with ParticleListQuery.
 */
